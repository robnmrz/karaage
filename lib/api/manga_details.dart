...
Future<MangaDetailsResponse> getMangaDetails({
  required String id,
}) async {
  Uri apiUrl = generateMangaDetailsUri(
    id: id,
  );
  try {
...
Uri generateMangaDetailsUri({
  ...
  String compactQuery = mangaDetailsQuery.replaceAll("\n", " ").replaceAll("  ", " ").trim();
